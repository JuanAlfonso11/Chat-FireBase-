...
import com.example.fbct2.databinding.ActivitySingInBinding;
...
public class SingInActivity extends AppCompatActivity {
    ...
    private void loading(Boolean isLoading){
        if(isLoading){
            binding.buttonSignIn.setVisibility(binding.buttonSignIn.INVISIBLE);
            binding.progressBar.setVisibility(binding.progressBar.VISIBLE);
        }else{
            binding.buttonSignIn.setVisibility(binding.buttonSignIn.VISIBLE);
